...
import Sidebar, {
  AdminMobileNavSheet,
} from "@/features/admin-shell/components/Sidebar";
            ...
            <div className="flex items-center gap-4 px-4 py-3.5 sm:px-6">
              ...
              <div className="ml-auto flex items-center gap-3">
                ...
                <Link
                  to="/admin/account"
                  className={cn(
                    "hidden md:flex size-9 items-center justify-center overflow-hidden rounded-full bg-primary/10 text-sm font-semibold text-primary transition hover:bg-primary/20",
