export function FacebookIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="size-4">
      ...
      />
      <path
        d="M16.671 15.563l.532-3.49h-3.328v-2.25c0-.949.465-1.874 1.956-1.874h1.513V5.996s-1.374-.235-2.686-.235c-2.741 0-4.533 1.672-4.533 4.697v2.953H7.078v3.49h3.047V24h2.797v-8.437h2.749z"
        fill="#fff"
      />
    </svg>
  );
