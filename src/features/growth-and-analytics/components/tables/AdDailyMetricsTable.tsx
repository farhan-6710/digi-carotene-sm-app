...
import type { AdDailyMetricsTableProps } from "../../types/components";
import {
  dayLabel,
  formatCompact,
  formatCpm,
...
export function AdDailyMetricsTable({
  ...
  return (
    <DirectoryTable
      title="Daily metrics"
      description="One row per synced day for this ad."
      ...
      emptyMessage="No daily metrics stored for this ad yet."
    >
      {rows.map((row) => {
