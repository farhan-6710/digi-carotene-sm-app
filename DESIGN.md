...
How the app is built. Product + onboarding: [docs-2026-08-26/README.md](docs-2026-08-26/README.md). Change rules: [AGENTS.md](AGENTS.md).
...
- Route guards (`TeamRoute`, `ClientRoute`, `UserRoute`) redirect by `profiles.role`. Details: [docs-2026-08-26/auth-and-features.md](docs-2026-08-26/auth-and-features.md).

## Domain

`clients` → `projects` → `posts`. Extra project team: `project_team_members` (`ended_at IS NULL`). Production plans hang off **clients**. Schema: [docs-2026-08-26/database.md](docs-2026-08-26/database.md).
